  ...
  <div class="trade-container">
    ...
    <div class="content">
      ...
      <div class="detail">
        ...
        <ul
          class="list clearFix"
          v-for="(detailList, index) in detailArrayList"
          :key="index"
        >
          <li>
            <img style="width: 100px" :src="detailList.imgUrl" alt="" />
          </li>
          <li>
            <p>
              {{ detailList.skuName }}
    ...
    <div class="sub clearFix">
      <a class="subBtn btn" @click="SubmitOrder">提交订单</a>
    </div>
  </div>
</template>
  ...
  methods: {
    ...
    async SubmitOrder() {
      ...
      if(result.code == 200) {
        ...
        this.$router.push('/pay?traderNo='+this.orderID+'')
      }else{
        alert(result.message='请重新购买一个商品')
      }
    },
  },
  computed: {
